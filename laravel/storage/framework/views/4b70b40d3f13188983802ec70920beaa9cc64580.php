        ...
        <div class="row-padding">
            ...
            <div class="container pt-4 bg-white">
              <div class="row" style="padding:0px 0px">
                <div class="col m6">
                  <h1>Update Data Laptop</h1>
                  <hr>
                  <form action="<?php echo e(route('laptop.update',['laptop' => $laptop->id])); ?>" method="POST"  enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>"
                      id="Merek" name="Merek" value="<?php echo e(old('Merek') ?? $laptop->Merek); ?>">
...
unset($__errorArgs, $__bag); ?>"
                      id="Tipe" name="Tipe" value="<?php echo e(old('Tipe') ?? $laptop->Tipe); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="Processor" id="Processor">
                        ...
                        <?php echo e((old('Processor') ?? $laptop->Processor)==
                        'Intel Core i3 Gen 5' ? 'selected': ''); ?> > Intel Core i3 Gen 5
                        </option>
                        <option value="Intel Core i5 Gen 5"
                        <?php echo e((old('Processor')?? $laptop->Processor)==
                        'Intel Core i5 Gen 5' ? 'selected': ''); ?> > Intel Core i5 Gen 5
                        </option>
                        <option value="Intel Core i7 Gen 5"
                        <?php echo e((old('Processor')?? $laptop->Processor)==
                        'Intel Core i7 Gen 5' ? 'selected': ''); ?> > Intel Core i7 Gen 5
                        </option>
                        <option value="Intel Core i9 Gen 5"
                        <?php echo e((old('Processor')?? $laptop->Processor)==
                        'Intel Core i9 Gen 5' ? 'selected': ''); ?> > Intel Core i9 Gen 5
                        </option>
                        <option value="Intel Core i3 Gen 7"
                        <?php echo e((old('Processor')?? $laptop->Processor)==
                        'Intel Core i3 Gen 7' ? 'selected': ''); ?> > Intel Core i3 Gen 7
                        </option>
                        <option value="Intel Core i5 Gen 7"
                        <?php echo e((old('Processor')?? $laptop->Processor)==
                        'Intel Core i5 Gen 7' ? 'selected': ''); ?> > Intel Core i5 Gen 7
                        </option>
                        <option value="Intel Core i7 Gen 7"
                        <?php echo e((old('Processor')?? $laptop->Processor)==
                        'Intel Core i7 Gen 7' ? 'selected': ''); ?> > Intel Core i7 Gen 7
                        </option>
                        <option value="Intel Core i9 Gen 7"
                        <?php echo e((old('Processor')?? $laptop->Processor)==
                        'Intel Core i7 Gen 7' ? 'selected': ''); ?> > Intel Core i9 Gen 7
                        </option>
                      </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                      <label for="Tipe_RAM">Tipe RAM</label>
                      <select class="form-control" name="Tipe_RAM" id="Tipe_RAM">
                        <option value="DRAM"
                        <?php echo e((old('Tipe_RAM')?? $laptop->Tipe_RAM)==
                        'DRAM' ? 'selected': ''); ?> > DRAM
                        </option>
                        <option value="RDRAM"
                        <?php echo e((old('Tipe_RAM')?? $laptop->Tipe_RAM)==
                        'RDRAM' ? 'selected': ''); ?> > RDRAM
                        </option>
                        <option value="EDORAM"
                        <?php echo e((old('Tipe_RAM')?? $laptop->Tipe_RAM)==
                        'EDORAM' ? 'selected': ''); ?> >EDORAM
                        </option>
                        <option value="DDR3"
                        <?php echo e((old('Tipe_RAM')?? $laptop->Tipe_RAM)==
                        'DDR3' ? 'selected': ''); ?> >DDR3
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="Kapasitas_RAM" id="Kapasitas_RAM">
                        <option value="4 GB"
                        <?php echo e((old('Kapasitas_RAM')?? $laptop->Kapasitas_RAM)==
                        '4 GB' ? 'selected': ''); ?> >4 GB
                        </option>
                        <option value="8 GB"
                        <?php echo e((old('Kapasitas_RAM')?? $laptop->Kapasitas_RAM)==
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="Tipe_Memori" id="Tipe_Memori">
                        <option value="SSD"
                        <?php echo e((old('Tipe_Memori')?? $laptop->Tipe_Memori)==
                        'SSD' ? 'selected': ''); ?> >SSD
                        </option>
                        <option value="HDD"
                        <?php echo e((old('Tipe_Memori')?? $laptop->Tipe_Memori)==
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                      <label for="Kapasitas_Memori">Kapasitas Memori</label>
                      <select class="form-control" name="Kapasitas_Memori" id="Kapasitas_Memori">
                        <option value="256 GB"
                        <?php echo e((old('Kapasitas_Memori')?? $laptop->Kapasitas_Memori)==
                        '256 GB' ? 'selected': ''); ?> >256 GB
                        </option>
                        <option value="512 GB"
                        <?php echo e((old('Kapasitas_Memori')?? $laptop->Kapasitas_Memori)==
                        '512 GB' ? 'selected': ''); ?> >512 GB
                        </option>
                        <option value="1 T"
                        <?php echo e((old('Kapasitas_Memori')?? $laptop->Kapasitas_Memori)==
                        '1 T' ? 'selected': ''); ?> >1 T
...
unset($__errorArgs, $__bag); ?>"
                      id="Harga" name="Harga" value="<?php echo e(old('Harga') ?? $laptop->Harga); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <br><img height="150px" src="<?php echo e(url('')); ?>/<?php echo e($laptop->image); ?>" class="rounded" alt="">
...
unset($__errorArgs, $__bag); ?>
            ...
            <br>
                ...
                <br>
                <img class="image round-large" src="<?php echo e(url('')); ?>/<?php echo e($laptop->image); ?>" alt="Buildings" width="700" height="394">
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\ANNIDA_240_SC1\sc1_annida-nur-islami_19102240\powpow\laravel\resources\views/laptop/edit.blade.php ENDPATH**/ ?>