            ...
            <div class="container pt-4 bg-white">
              <div class="row" style="padding:0px 0px">
                <div class="col m6">
                  ...
                  <hr>
                  <form action="{{ route('laptop.update',['laptop' => $laptop->id]) }}" method="POST"  enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    <div class="form-group">
                      ...
                      id="Merek" name="Merek" value="{{ old('Merek') ?? $laptop->Merek }}">
                      @error('Merek')
                    ...
                    <div class="form-group">
                      ...
                      id="Tipe" name="Tipe" value="{{ old('Tipe') ?? $laptop->Tipe }}">
                      @error('Tipe')
                      <div class="text-danger">{{ $message }}</div>
                      @enderror
                    </div>
                    <div class="form-group">
                      ...
                      <select class="form-control" name="Processor" id="Processor">
                        ...
                        {{ (old('Processor') ?? $laptop->Processor)==
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="Kapasitas_RAM" id="Kapasitas_RAM">
                        <option value="4 GB"
                        {{ (old('Kapasitas_RAM')?? $laptop->Kapasitas_RAM)==
                        '4 GB' ? 'selected': '' }} >4 GB
                        </option>
                        <option value="8 GB"
                        {{ (old('Kapasitas_RAM')?? $laptop->Kapasitas_RAM)==
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="Tipe_Memori" id="Tipe_Memori">
                        <option value="SSD"
                        {{ (old('Tipe_Memori')?? $laptop->Tipe_Memori)==
                        'SSD' ? 'selected': '' }} >SSD
                        </option>
                        <option value="HDD"
                        {{ (old('Tipe_Memori')?? $laptop->Tipe_Memori)==
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="Kapasitas_Memori" id="Kapasitas_Memori">
                        <option value="256 GB"
                        {{ (old('Kapasitas_Memori')?? $laptop->Kapasitas_Memori)==
                    ...
                    <div class="form-group">
                      ...
                      id="Harga" name="Harga" value="{{ old('Harga') ?? $laptop->Harga }}">
                      @error('Harga')
                      <div class="text-danger">{{ $message }}</div>
                      @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <br><img height="150px" src="{{url('')}}/{{$laptop->image}}" class="rounded" alt="">
